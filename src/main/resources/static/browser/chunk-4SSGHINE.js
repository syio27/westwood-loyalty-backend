...
function PaymentsPageComponent_div_3_div_145_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("onClick", function PaymentsPageComponent_div_3_div_145_Template_app_button_onClick_6_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.clearFilters());
    });
...
function PaymentsPageComponent_div_3_div_146_div_17_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 142)(1, "app-pagination", 143);
...
function PaymentsPageComponent_div_3_div_146_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 134)(1, "div", 135)(2, "div", 136)(3, "span");
    \u0275\u0275text(4);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "div", 137)(6, "label", 138);
    \u0275\u0275text(7, "\u0421\u0442\u0440\u043E\u043A \u043D\u0430 \u0441\u0442\u0440\u0430\u043D\u0438\u0446\u0435:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "select", 139);
    ...
    \u0275\u0275text(14, "50");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "option", 140);
    \u0275\u0275text(16, "100");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275template(17, PaymentsPageComponent_div_3_div_146_div_17_Template, 2, 2, "div", 141);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
var PaymentsPageComponent = class _PaymentsPageComponent {
  ...
  updateUrlFromState() {
    ...
    if (this.searchPaymentId.trim())
      queryParams["paymentId"] = this.searchPaymentId.trim();
    if (this.searchClientName.trim())
      queryParams["clientName"] = this.searchClientName.trim();
...
(() => {
  ...
  `, styles: [`/* angular:styles/component:css;aa24f8826837afc708368fe04b1708b2ed003cda4612480e047bb3444130e427;/Users/baglan/repo/westwood/westwood-frontend/src/app/features/payments/pages/payments-page/payments-page.component.ts */
.page-wrapper {
  min-height: 100%;
  margin: -2rem;
  padding: 2rem;
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PaymentsPageComponent, { className: "PaymentsPageComponent", filePath: "src/app/features/payments/pages/payments-page/payments-page.component.ts", lineNumber: 1320 });
})();
export {
  PaymentsPageComponent
};
//# sourceMappingURL=chunk-4SSGHINE.js.map
