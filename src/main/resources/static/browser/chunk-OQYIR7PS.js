...
var AUTH_ROUTES = [
  ...
  {
    path: "login",
    loadComponent: () => import("./chunk-O2PMQEOH.js").then((m) => m.LoginPageComponent),
    title: "Login"
  },
  ...
  {
    path: "activation",
    loadComponent: () => import("./chunk-6LEBZHPQ.js").then((m) => m.ActivationPageComponent),
    canActivate: [activationGuard],
    title: "Activation"
  },
  {
    path: "forgot-password",
    loadComponent: () => import("./chunk-NX7TVJOY.js").then((m) => m.ForgotPasswordPageComponent),
    title: "Forgot Password"
  },
  {
    path: "reset-password",
    loadComponent: () => import("./chunk-N3QTFBWV.js").then((m) => m.ResetPasswordPageComponent),
...
//# sourceMappingURL=chunk-OQYIR7PS.js.map
