...
function PaymentViewModalComponent_div_1_ng_container_31_div_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 44)(1, "app-badge", 45);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
...
function PaymentViewModalComponent_div_1_ng_container_31_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, PaymentViewModalComponent_div_1_ng_container_31_div_1_Template, 5, 2, "div", 43);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const ctx_r0 = \u0275\u0275nextContext(2);
...
function PaymentViewModalComponent_div_1_ng_container_32_div_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 47)(1, "app-badge", 48);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function PaymentViewModalComponent_div_1_div_33_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 47)(1, "app-badge", 49);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function PaymentViewModalComponent_div_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(8);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(22, _c0, ctx_r0.paymentData.clientId));
    \u0275\u0275advance();
...
var PaymentViewModalComponent = class _PaymentViewModalComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PaymentViewModalComponent, selectors: [["app-payment-view-modal"]], inputs: { visible: "visible", paymentTxId: "paymentTxId", paymentSearchResult: "paymentSearchResult" }, outputs: { visibleChange: "visibleChange", paymentUpdated: "paymentUpdated", refundedPaymentClick: "refundedPaymentClick" }, features: [\u0275\u0275NgOnChangesFeature], decls: 3, vars: 5, consts: [["title", "\u0414\u0435\u0442\u0430\u043B\u0438 \u043F\u043B\u0430\u0442\u0435\u0436\u0430", 3, "closed", "visible", "showCloseButton", "size"], ["class", "payment-view-content", 4, "ngIf"], ["class", "loading-state", 4, "ngIf"], [1, "payment-view-content"], [1, "payment-header"], [1, "payment-id-section"], [1, "payment-id-label"], [1, "payment-id-value"], [1, "payment-status"], ["size", "medium", 3, "badgeType", "icon"], [1, "payment-info-grid"], [1, "info-column"], [1, "info-section"], [1, "section-title"], [1, "info-item"], [1, "info-label"], [1, "info-value", "amount"], [1, "payment-method-section"], ["badgeType", "paymentMethod", "size", "medium", 3, "paymentMethod", 4, "ngIf"], ["class", "method-selector", 4, "ngIf"], ["class", "edit-method-btn", 3, "click", 4, "ngIf"], [1, "bonus-info-section"], [4, "ngIf"], ["class", "bonus-item", 4, "ngIf"], ["class", "bonus-none", 4, "ngIf"], ["class", "info-item", 4, "ngIf"], [1, "info-value", "link", 3, "routerLink"], ["class", "info-value link", 3, "routerLink", 4, "ngIf"], ["class", "info-value", 4, "ngIf"], [1, "info-value"], ["badgeType", "paymentMethod", "size", "medium", 3, "paymentMethod"], [1, "method-selector"], [1, "method-select", 3, "ngModelChange", "ngModel"], ["value", "CASH"], ["value", "CARD"], ["value", "TRANSFER"], [1, "method-actions"], [1, "method-btn", "save", 3, "click", "disabled"], [1, "method-btn", "cancel", 3, "click"], [1, "edit-method-btn", 3, "click"], ["viewBox", "0 0 24 24", "fill", "none"], ["d", "M11 4H4a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2v-7", "stroke", "currentColor", "stroke-width", "2"], ["d", "M18.5 2.5a2.121 2.121 0 013 3L12 15l-4 1 1-4 9.5-9.5z", "stroke", "currentColor", "stroke-width", "2"], ["class", "bonus-item revoked", 4, "ngFor", "ngForOf"], [1, "bonus-item", "revoked"], ["badgeType", "danger", "size", "small", "icon", "refund"], [1, "revoke-reason"], [1, "bonus-item"], ["badgeType", "bonusGranted", "size", "small", "icon", "star"], ["badgeType", "bonusUsed", "size", "small", "icon", "check"], [1, "bonus-none"], [1, "info-value", "notes"], [1, "info-value", "refund-link", 3, "click"], [1, "loading-state"], [1, "loader"]], template: function PaymentViewModalComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "app-modal", 0);
      \u0275\u0275listener("closed", function PaymentViewModalComponent_Template_app_modal_closed_0_listener() {
        return ctx.onClose();
      });
      \u0275\u0275template(1, PaymentViewModalComponent_div_1_Template, 62, 24, "div", 1)(2, PaymentViewModalComponent_div_2_Template, 4, 0, "div", 2);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PaymentViewModalComponent, { className: "PaymentViewModalComponent", filePath: "src/app/shared/components/payment-view-modal/payment-view-modal.component.ts", lineNumber: 539 });
})();

export {
  PaymentViewModalComponent
};
//# sourceMappingURL=chunk-LWTVJENB.js.map
