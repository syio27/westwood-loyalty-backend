...
var routes = [
  ...
  {
    path: "auth",
    loadChildren: () => import("./chunk-OQYIR7PS.js").then((m) => m.AUTH_ROUTES),
    canActivate: [guestGuard]
  },
  {
    path: "",
    loadComponent: () => import("./chunk-XV2I7TPG.js").then((m) => m.MainLayoutWrapperComponent),
    canActivate: [authGuard],
    children: [
      {
        path: "home",
        loadComponent: () => import("./chunk-PXSBD4XT.js").then((m) => m.HomePageComponent),
        title: "Home"
      },
      {
        path: "communications",
        ...
        children: [
          ...
          {
            path: "whatsapp",
            loadComponent: () => import("./chunk-3BLLKOGD.js").then((m) => m.InvitationPageComponent),
            title: "WhatsApp"
          }
          // {
          //   path: 'email',
      ...
      {
        path: "bonus-program",
        loadComponent: () => import("./chunk-NZNAASP2.js").then((m) => m.BonusProgramPageComponent),
        title: "Bonus Program"
      },
      {
        path: "clients",
        loadComponent: () => import("./chunk-DA25T4OD.js").then((m) => m.ClientsPageComponent),
        title: "Clients"
      },
      {
        path: "clients/:id",
        loadComponent: () => import("./chunk-7LGACJ5V.js").then((m) => m.ProfilePageComponent),
        title: "Client"
      },
      {
        path: "payments",
        loadComponent: () => import("./chunk-3ZKAMVG4.js").then((m) => m.PaymentsPageComponent),
        title: "Payments"
      },
      {
        path: "users",
        loadComponent: () => import("./chunk-KMG6BE5K.js").then((m) => m.UsersPageComponent),
        title: "Users"
      },
      {
        path: "users/:id",
        loadComponent: () => import("./chunk-AVFLAUEL.js").then((m) => m.UserProfilePageComponent),
        title: "User"
      },
      {
        path: "profile",
        loadComponent: () => import("./chunk-XRSEBTUO.js").then((m) => m.AccountPageComponent),
        title: "Profile"
      }
    ]
  },
