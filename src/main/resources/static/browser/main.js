...
var routes = [
  ...
  {
    path: "auth",
    loadChildren: () => import("./chunk-O7DGRDNA.js").then((m) => m.AUTH_ROUTES),
    canActivate: [guestGuard]
  },
  {
    path: "",
    loadComponent: () => import("./chunk-IRESW5ZH.js").then((m) => m.MainLayoutWrapperComponent),
    canActivate: [authGuard],
    children: [
      {
        path: "home",
        loadComponent: () => import("./chunk-YR2I3ZVU.js").then((m) => m.HomePageComponent),
        title: "Home"
      },
      {
        path: "bonus-expiring",
        loadComponent: () => import("./chunk-D6YYJQRT.js").then((m) => m.BonusExpiringPageComponent),
      ...
      },
      {
        ...
        children: [
          ...
          {
            path: "whatsapp",
            loadComponent: () => import("./chunk-RJ7P5REC.js").then((m) => m.InvitationPageComponent),
            title: "WhatsApp"
          }
          // {
          //   path: 'email',
      ...
      },
      {
        ...
        loadComponent: () => import("./chunk-SI7H5HC7.js").then((m) => m.BonusTypeReportPageComponent),
      ...
      },
      {
        ...
        children: [
          {
            path: "",
            loadComponent: () => import("./chunk-BZIIBSLJ.js").then((m) => m.BonusProgramPageComponent),
            title: "Reward Programs"
          },
          {
            path: "programs",
            loadComponent: () => import("./chunk-VCBBSPOK.js").then((m) => m.ProgramTypesPageComponent),
          ...
          },
          {
            ...
            loadComponent: () => import("./chunk-ESNDKRJS.js").then((m) => m.CreateProgramWizardComponent),
            title: "Create Cashback Program"
          },
          /* Other types: in development */
          {
            path: "create/welcome/:uuid",
            loadComponent: () => import("./chunk-G5ZIR235.js").then((m) => m.RewardProgramCreatePageComponent),
          ...
          },
          {
            ...
            loadComponent: () => import("./chunk-WTCPOZVF.js").then((m) => m.ProgramTierPageComponent),
            title: "Tier"
          },
          {
            path: "view/:uuid/:tab",
            loadComponent: () => import("./chunk-ID7TYUH3.js").then((m) => m.ProgramViewPageComponent),
            title: "View Program"
          },
          {
            path: "configure/:type/:uuid",
            loadComponent: () => import("./chunk-3HNUQF4F.js").then((m) => m.RewardProgramConfigurePageComponent),
      ...
      },
      {
        ...
        loadComponent: () => import("./chunk-E2P7LBEN.js").then((m) => m.BonusManagementPageComponent),
        title: "Bonus Management"
      },
      {
        path: "clients",
        loadComponent: () => import("./chunk-YDJ3TFHD.js").then((m) => m.ClientsPageComponent),
        title: "Clients"
      },
      {
        path: "clients/:id",
        loadComponent: () => import("./chunk-DTI3PVV3.js").then((m) => m.ProfilePageComponent),
        title: "Client"
      },
      {
      ...
      {
        path: "payments",
        loadComponent: () => import("./chunk-4SSGHINE.js").then((m) => m.PaymentsPageComponent),
        title: "Payments"
      },
      {
        path: "users",
        loadComponent: () => import("./chunk-IGBNUDQB.js").then((m) => m.UsersPageComponent),
        title: "Users"
      },
      {
        path: "users/:id",
        loadComponent: () => import("./chunk-RD4UUG55.js").then((m) => m.UserProfilePageComponent),
        title: "User"
      },
      {
        path: "profile",
        loadComponent: () => import("./chunk-J2C5SXXH.js").then((m) => m.AccountPageComponent),
        title: "Profile"
      }
    ]
  },
