...
var AUTH_ROUTES = [
  ...
  {
    path: "login",
    loadComponent: () => import("./chunk-QTB6JJP5.js").then((m) => m.LoginPageComponent),
    title: "Login"
  },
  ...
  {
    path: "activation",
    loadComponent: () => import("./chunk-GVHJA2B6.js").then((m) => m.ActivationPageComponent),
    canActivate: [activationGuard],
    title: "Activation"
  },
  {
    path: "forgot-password",
    loadComponent: () => import("./chunk-YSKGUGE6.js").then((m) => m.ForgotPasswordPageComponent),
    title: "Forgot Password"
  },
  {
    path: "reset-password",
    loadComponent: () => import("./chunk-ZJQAHQ6I.js").then((m) => m.ResetPasswordPageComponent),
...
//# sourceMappingURL=chunk-XRPZLS4H.js.map
