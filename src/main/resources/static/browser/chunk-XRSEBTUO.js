...
function AccountPageComponent_div_3_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(14);
    \u0275\u0275elementEnd();
    \u0275\u0275template(15, AccountPageComponent_div_3_p_15_Template, 2, 1, "p", 18);
    ...
    \u0275\u0275text(52, "\u0422\u0435\u043B\u0435\u0444\u043E\u043D:");
    \u0275\u0275elementEnd();
    \u0275\u0275template(53, AccountPageComponent_div_3_span_53_Template, 2, 1, "span", 36)(54, AccountPageComponent_div_3_input_54_Template, 1, 1, "input", 40);
    \u0275\u0275elementEnd();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AccountPageComponent, { className: "AccountPageComponent", filePath: "src/app/features/users/pages/account-page/account-page.component.ts", lineNumber: 1091 });
})();
export {
  AccountPageComponent
};
//# sourceMappingURL=chunk-XRSEBTUO.js.map
