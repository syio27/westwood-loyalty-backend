...
(() => {
  ...
  `, styles: ["/* angular:styles/component:css;bb12b219edbe5377affa2bd8c4b41e35c54e148c2b28ad5aa00a77cc925f01d4;/Users/baglan/repo/westwood/westwood-frontend/src/app/shared/components/input/input.component.ts */\n.input-wrapper {\n  display: flex;\n  flex-direction: column;\n  gap: 0.5rem;\n  width: 100%;\n}\n.input-label {\n  font-weight: 500;\n  font-size: 0.875rem;\n  color: #1a202c;\n}\n.required-mark {\n  color: #dc3545;\n  margin-left: 0.25rem;\n}\n.input-container {\n  position: relative;\n  display: flex;\n  align-items: center;\n}\ninput {\n  width: 100%;\n  padding: 0.625rem 0.875rem;\n  border: 1px solid var(--color-input-border);\n  border-radius: 6px;\n  font-size: 0.875rem;\n  transition: all 0.2s ease;\n  background-color: #ffffff;\n  color: #1a202c;\n}\ninput:hover {\n  border-color: var(--color-input-border-hover);\n}\ninput:focus {\n  outline: none;\n  border-color: var(--color-input-border-focus);\n  box-shadow: 0 0 0 3px var(--color-input-shadow-focus);\n}\ninput.error {\n  border-color: var(--color-input-error);\n}\ninput.error:focus {\n  box-shadow: 0 0 0 3px var(--color-input-error-shadow);\n}\ninput:disabled {\n  background-color: #f8f9fa;\n  color: #94a3b8;\n  cursor: not-allowed;\n}\ninput.readonly {\n  background-color: #f8f9fa;\n  cursor: default;\n}\ninput.has-prefix {\n  padding-left: 2.5rem;\n}\ninput.has-suffix {\n  padding-right: 2.5rem;\n}\n.input-prefix,\n.input-suffix {\n  position: absolute;\n  color: #64748b;\n  font-size: 0.875rem;\n  pointer-events: none;\n}\n.input-prefix {\n  left: 0.875rem;\n}\n.input-suffix {\n  right: 0.875rem;\n}\n.password-toggle-btn {\n  position: absolute;\n  right: 0.75rem;\n  background: none;\n  border: none;\n  padding: 0.25rem;\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  color: #64748b;\n  transition: color 0.2s ease;\n  z-index: 1;\n}\n.password-toggle-btn:hover {\n  color: #1a202c;\n}\n.password-toggle-btn:focus {\n  outline: none;\n  color: #15803d;\n}\n.eye-icon {\n  width: 20px;\n  height: 20px;\n  display: block;\n}\n.input-footer {\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  min-height: 1.25rem;\n}\n.error-message {\n  color: #dc3545;\n  font-size: 0.75rem;\n}\n.hint-message {\n  color: #64748b;\n  font-size: 0.75rem;\n}\n.char-count {\n  color: #94a3b8;\n  font-size: 0.75rem;\n  margin-left: auto;\n}\n/*# sourceMappingURL=input.component.css.map */\n"] }]
  }], null, { id: [{
    type: Input
  }], label: [{
    type: Input
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(InputComponent, { className: "InputComponent", filePath: "src/app/shared/components/input/input.component.ts", lineNumber: 208 });
})();
...
//# sourceMappingURL=chunk-B5GAVZDN.js.map
